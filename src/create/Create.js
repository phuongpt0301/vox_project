    ...
    render(): React$Element<*> {
        ...
        return <BaseContainer title="Create New" navigation={this.props.navigation} scrollable>
            ...
            <Field
                ...
                right={() => <Icon name="ios-add-outline" style={StyleSheet.flatten(style.icon)} />}
            />
            <Field
                label="Time"
            ...
            <Field
                ...
                right={() => <Icon name="ios-pin-outline" style={StyleSheet.flatten(style.icon)}  />}
            />
            <ListItem last>
                <Body>
                    <Text style={{ fontSize: variables.inputFontSize }}>Add People</Text>
                </Body>
                <Right style={StyleSheet.flatten(style.avatars)}>
